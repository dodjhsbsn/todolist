    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const ListTile(
              title: Text('任务创建统计',style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
              subtitle: Text('Task Create Time'),
            ),
            const SizedBox(height: 16),
            AspectRatio(aspectRatio: 1.7, child: dataVisualizationController.buildLineChart()),
            const SizedBox(height: 16),
            const SizedBox(height: 16),
            const ListTile(
              title: Text('任务结束统计',style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
